//
//  AorValSclTableViewController.m
//  IHarvey
//
...
#import "AorValSclFinalViewController.h"

static NSString *kCellIdentifier = @"MyIdentifier";
static NSString *kTitleKey = @"title";
static NSString *kViewControllerKey = @"viewController";

@implementation AorValSclTableViewController
...
{	
	...
	AorValSclFinalViewController *aorValSclFinalViewController = [[AorValSclFinalViewController alloc]
														  initWithNibName:@"AorValSclFinalViewController" bundle:nil];
	[aorValSclFinalViewController setTitle:@"Final Diagnosis"];
	[self.menuListAorValScl addObject:[NSDictionary dictionaryWithObjectsAndKeys:
								   NSLocalizedString(@"Final Diagnosis", @""), kTitleKey,
								   aorValSclFinalViewController, kViewControllerKey,
								   nil]];
	
	[aorValSclFinalViewController release];
