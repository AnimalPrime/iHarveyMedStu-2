...
@implementation IntroHSInfoViewController
...
-(IBAction)vidplay {
    ...
    [TestFlight passCheckpoint:@"44 - HSinfo - Vid Play Aor"];
...
-(IBAction)pvidp {
	[TestFlight passCheckpoint:@"44 - HSinfo - Vid Play Pul"];
...
-(IBAction)pvidt {
    ...
    [TestFlight passCheckpoint:@"44 - HSinfo - Vid Play Tri"];
...
-(IBAction)pvidm {
	...
	[TestFlight passCheckpoint:@"44 - HSinfo - Vid Play Mit"];
