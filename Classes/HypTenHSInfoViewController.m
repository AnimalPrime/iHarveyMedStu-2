...
@implementation HypTenHSInfoViewController
...
-(IBAction)vidplay {
     [TestFlight passCheckpoint:@"36 - HSinfo - Vid Play Aor"];
...
-(IBAction)pvidp {
	 [TestFlight passCheckpoint:@"36 - HSinfo - Vid Play Pul"];
...
-(IBAction)pvidt {
	 [TestFlight passCheckpoint:@"36 - HSinfo - Vid Play Tri"];
...
-(IBAction)pvidm {
     [TestFlight passCheckpoint:@"36 - HSinfo - Vid Play Mit"];
